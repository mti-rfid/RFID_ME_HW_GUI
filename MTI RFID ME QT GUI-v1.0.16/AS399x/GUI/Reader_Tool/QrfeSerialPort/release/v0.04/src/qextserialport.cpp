...
*/
QextSerialPort::QextSerialPort(PortSettings const& settings, QObject* parent)
 : QextBaseType(settings, parent)
{}
...
*/
QextSerialPort::QextSerialPort(const QString & name, PortSettings const& settings, QObject* parent)
 : QextBaseType(name, settings, parent)
{}
