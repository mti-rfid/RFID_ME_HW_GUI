...
public:
    QextSerialPort(QObject* parent = 0);
    QextSerialPort(const QString & name, QObject* parent = 0);
    QextSerialPort(PortSettings const& s, QObject* parent = 0);
    QextSerialPort(const QString & name, PortSettings const& s, QObject* parent = 0);
